...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post coaches_url, params: { coach: { leagueteam_id: @coach.leagueteam_id, license: @coach.license, person_id: @coach.person_id } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { leagueteam_id: @coach.leagueteam_id, license: @coach.license, person_id: @coach.person_id } }
