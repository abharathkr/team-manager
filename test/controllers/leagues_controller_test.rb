...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { club: @league.club, leaguename: @league.leaguename } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { club: @league.club, leaguename: @league.leaguename } }
