...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference('Athlete.count') do
      post athletes_url, params: { athlete: { leagueteam_id: @athlete.leagueteam_id, person_id: @athlete.person_id, roster: @athlete.roster } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { leagueteam_id: @athlete.leagueteam_id, person_id: @athlete.person_id, roster: @athlete.roster } }
