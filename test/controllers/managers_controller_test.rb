...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post managers_url, params: { manager: { leagueteam_id: @manager.leagueteam_id, person_id: @manager.person_id } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { leagueteam_id: @manager.leagueteam_id, person_id: @manager.person_id } }
